...
export const siteConfig: SiteConfig = {
	title: "Blog",
	subtitle: "Pianouo's Blog",
	siteURL: "https://pianouo.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				...
				"/assets/desktop-banner/02.jpg",
				"/assets/desktop-banner/03.jpg",
				"/assets/desktop-banner/04.jpg",
				"/assets/desktop-banner/00.png",
		...
		homeText: {
			...
			title: "Blog From Pianouo", // 主页横幅主标题
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/pianouo",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/413721864",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "CSDN",
					url: "https://blog.csdn.net/weixin_74091754",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	...
	name: "Pianouo",
	bio: "Studying Cryptography at NKU.",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "flag_{Hello, World!}", // 公告内容
